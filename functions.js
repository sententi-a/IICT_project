...
function choose2(x, y, z) {
  ...
  if (30 <= frame) {
    ...
    if (mouseX > 21 && mouseX < 90 && mouseY > 510 && mouseY < 540) {
     ...
     text("3", 19, 532);
    if (mouseIsPressed && mouseX > 21 && mouseX < 100 && mouseY > 440 && mouseY < 470) {
      stage2 = x;
      frame = 0;
    }
    if (mouseIsPressed && mouseX > 20 && mouseX < 160 && mouseY > 475 && mouseY < 505) {
      stage2 = y;
      frame = 0;
    }
    if (mouseIsPressed &&mouseX > 21 && mouseX < 90 && mouseY > 510 && mouseY < 540) {
      stage2 = z;
      frame = 0;
    }
  }
...
function twoChoose0(x,y){
  ...
  if ( mouseIsPressed && 10 <= mouseX &&mouseX <= 400 &&457 <= mouseY &&mouseY <= 505) {
      stage0 = x;
      frame = 0;
  }
  if (mouseIsPressed &&10 <= mouseX &&mouseX <= 400 &&510 <= mouseY && mouseY <= 540) {
      stage0 = y;
      frame = 0;
  }
}
...
function twoChoose11(x,y){
  ...
  if ( mouseIsPressed &&10 <= mouseX &&mouseX <= 420&&457 <= mouseY &&mouseY <= 505) {
      stage1 = x;
      frame = 0;
  }
  if (mouseIsPressed &&10 <= mouseX &&mouseX <= 580 &&510 <= mouseY && mouseY <= 540) {
      stage1 = y;
      frame = 0;
  }
}
